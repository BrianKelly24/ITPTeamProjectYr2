...
<br>
<!-- Form Name -->
<h1 style= "color:#263d66; text-align:center"><b><u>General Pc Builder</b></u></h1>
</div>
<br>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="generaluse">Which activity do you spend most of your time on?</label>
  <div class="col-md-4">
  <div class="radio">
    <label for="generaluse-0">
      <input type="radio" name="q1" id="generaluse-0" value="31" checked="checked">
      General Web Browsing
    </label>
	</div>
  <div class="radio">
    <label for="generaluse-1">
      <input type="radio" name="q1" id="generaluse-1" value="32">
      Using Application's
    </label>
	</div>
  <div class="radio">
    <label for="generaluse-2">
      <input type="radio" name="q1" id="generaluse-2" value="33">
      Video Streaming, Including Online
    </label>
	</div>
  </div>
</div>
...
<!-- Multiple Radios -->
<div class="form-group">
  <label class="col-md-4 control-label" for="program">Do you use any of the softwares </label>
  <div class="col-md-4">
  <div class="radio">
    <label for="program-0">
      <input type="radio" name="q2" id="program-0" value="34" checked="checked">
      Photoshop / Lightroom
    </label>
	</div>
  <div class="radio">
    <label for="program-1">
      <input type="radio" name="q2" id="program-1" value="35">
      Any Film Editing Software
    </label>
	</div>
  <div class="radio">
    <label for="program-2">
      <input type="radio" name="q2" id="program-2" value="36">
      Music Software
    </label>
	</div>
  <div class="radio">
    <label for="program-3">
      <input type="radio" name="q2" id="program-3" value="37">
      Microsoft Office
    </label>
	</div>
  <div class="radio">
    <label for="program-4">
      <input type="radio" name="q2" id="program-4" value="38">
      Other High intensive Softwares
    </label>
	</div>
  <div class="radio">
    <label for="program-5">
      <input type="radio" name="q2" id="program-5" value="39">
...
<div class="form-group">
  ...
  <div class="radio">
	...
	<div class="radio">
    <label for="accessories-2">
      <input type="radio" name="q7" id="accessories-3" value="none">
      None
    </label>
	</div>
  </div>
