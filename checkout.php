...
<ul class="form-style-1">
    ...
    <li><label>Card Number & CVC <span class="required">*</span></label><input type="text" name="field1" class="field-divided" placeholder="Card Number" />&nbsp;<input type="text" name="field2" class="field-divided" placeholder="CVC" /></li>
    <li>
